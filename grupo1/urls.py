...
urlpatterns = [
    ...
    path('workspaces/<int:owner_id>/<int:workspace_id>/boards/<int:board_id>/cards/<int:card_id>/update/cardlist/<int:cardlist_id>/', views.update_cardlist, name='update_cardlist'),
